        ...
        data(){
            return{
                pagedata:{
                    bg_words:'ABOUT',
                    title_words:'关于我们',
                    title_info:'驭风者影视以“驭风者，皓月当空；任驰骋，万里江山；一切尽在股掌！”为企业之魂，坚持以彰显湖湘精神，推动中国文化产业发展为已任，立志为国内文化产业发展翻开一页新篇章。',
                    page_url:[ '关于我们','企业文化'],
                    page_sec: [
                        {
